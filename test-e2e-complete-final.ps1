...
try {
    ...
    try {
        ...
        Write-Host "`n3. Verifying response structure matches QuestionApiModel..." -ForegroundColor Yellow
...
Write-Host "- If all checks passed, the frontend should now work correctly" -ForegroundColor White
Write-Host "- The backend returns exactly what QuestionApiModel expects" -ForegroundColor White
Write-Host "- The mapping logic should succeed" -ForegroundColor White
